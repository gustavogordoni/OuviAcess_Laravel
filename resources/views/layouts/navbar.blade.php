...
<nav class="navbar navbar-expand-md navbar-{{ $tema }} bg-{{ $tema }} sticky-top border-2 border-bottom border-info p-1"
  ...
  <div class="container-fluid mx-3 d-flex">
    ...
    <div class="offcanvas offcanvas-start text-bg-{{ $tema }}" tabindex="-1" id="offcanvasNavbar2"
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-center flex-grow-1 nav-pills">
          ...
          <li class="nav-item mx-2">
            <a href="{{ route('index') }}" class="nav-link {{ ativar('/') }} text-center">
          ...
          <li class="nav-item mx-2">
            <a href="{{ route('history') }}"
              class="nav-link {{ ativar('history') }}{{ history('history') }}{{ history('edit-request') }}{{ history('show-request') }} text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="15" height="15"
                fill="currentColor" viewBox="0 0 16 16">
                <path
          ...
          <li class="nav-item mx-2">
            <a href="{{ route('requests') }}"
              class="nav-link {{ ativar('requests') }}{{ requests('requests') }}{{ requests('respond-request') }}{{ requests('show-request') }} text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="15" height="15"
                fill="currentColor" viewBox="0 0 16 16">
                <path
                  d="M13 2.5a1.5 1.5 0 0 1 3 0v11a1.5 1.5 0 0 1-3 0v-.214c-2.162-1.241-4.49-1.843-6.912-2.083l.405 2.712A1 1 0 0 1 5.51 15.1h-.548a1 1 0 0 1-.916-.599l-1.85-3.49a68.14 68.14 0 0 0-.202-.003A2.014 2.014 0 0 1 0 9V7a2.02 2.02 0 0 1 1.992-2.013 74.663 74.663 0 0 0 2.483-.075c3.043-.154 6.148-.849 8.525-2.199V2.5zm1 0v11a.5.5 0 0 0 1 0v-11a.5.5 0 0 0-1 0zm-1 1.35c-2.344 1.205-5.209 1.842-8 2.033v4.233c.18.01.359.022.537.036 2.568.189 5.093.744 7.463 1.993V3.85zm-9 6.215v-4.13a95.09 95.09 0 0 1-1.992.052A1.02 1.02 0 0 0 1 7v2c0 .55.448 1.002 1.006 1.009A60.49 60.49 0 0 1 4 10.065zm-.657.975 1.609 3.037.01.024h.548l-.002-.014-.443-2.966a68.019 68.019 0 0 0-1.722-.082z" />
          ...
          @elseif ((Str::contains(request()->url(), 'edit-request') || (Str::contains(request()->url(),
          'respond-request'))))
        ...
        <div class="d-flex my-auto justify-content-evenly">
          ...
          @guest
          <a href="{{ route('authentication') }}"><button type="button"
              class="btn btn-outline-primary mx-1 rounded-pill">
          ...
          @php $btn_cadastro = "btn-danger";@endphp
          @else
          @php $btn_cadastro = "btn-outline-danger";@endphp
          @endif

          <a href="{{ route('register') }}"><button type="button" class="btn  {{ $btn_cadastro }} mx-1 rounded-pill">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href="{{ route('profile') }}"><button type="button" class="btn {{ $btn_perfil }} mx-1 rounded-pill">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
          ...
          <a href="{{ route('logout') }}"><button type="button" class="btn btn-outline-danger mx-1 rounded-pill">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-box-arrow-right mx-auto" viewBox="0 0 16 16">
                <path fill-rule="evenodd"
          ...
          <form action="{{ route('theme') }}" method="POST" class="my-auto">
            @csrf
            <button value="{{ $value }}" type="submit" class="btn {{ $class }} mx-1 rounded-circle p-2"
              id="alterar_tema" name="theme">{!! $Dark_Light !!}</button>
