<nav class="navbar navbar-expand-md navbar-@php //echo $tema @endphp bg-@php //echo $tema @endphp sticky-top border-2 border-bottom border-info p-1" aria-label="Offcanvas navbar large">
  <div class="container-fluid mx-3 d-flex">
    ...
    <div class="offcanvas offcanvas-start text-bg-@php //echo $tema @endphp" tabindex="-1" id="offcanvasNavbar2" aria-labelledby="offcanvasNavbar2Label">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-center flex-grow-1 nav-pills">
          ...
          <li class="nav-item mx-2">
            <a href="../." class="nav-link @php echo ativar('') @endphp text-center">
          ...
          <li class="nav-item mx-2">
            <a href="requerimento" class="nav-link @php echo ativar('requerimento') @endphp text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="15" height="15" fill="currentColor" viewBox="0 0 16 16">
          ...
          <li class="nav-item mx-2">
            <a href="historico" class="nav-link @php echo ativar('historico') @endphp @php ativar('visualizar-requerimento') @endphp @php ativar('editar-requerimento') @endphp @php ativar('excluir-requerimento') @endphp text-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="bi d-block mx-auto mb-1" width="15" height="15" fill="currentColor" viewBox="0 0 16 16">
          ...
          @php
          if (basename($_SERVER["PHP_SELF"]) == "visualizar-requerimento") {
          @endphp
          ...
          @endphp
          @php
          if (basename($_SERVER["PHP_SELF"]) == "editar-requerimento") {
          @endphp
        ...
        <div class="d-flex my-auto justify-content-evenly">
          ...
          if (!autenticado()) {
          @endphp
            <a href="login"><button type="button" class="btn btn-outline-primary mx-1 rounded-pill">
            ...
            <a href="cadastro-usuario"><button type="button" class="btn  @php //echo $btn_cadastro @endphp mx-1 rounded-pill">
